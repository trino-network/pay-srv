...
// NewPostCreateInvoiceParams creates a new PostCreateInvoiceParams object
// no default values defined in spec.
func NewPostCreateInvoiceParams() PostCreateInvoiceParams {

	return PostCreateInvoiceParams{}
}

// PostCreateInvoiceParams contains all the bound params for the post create invoice operation
